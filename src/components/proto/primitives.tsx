    ...
    >
      <span
        className={cn(
          ...
          offlineish && "bg-destructive animate-pulse",
        )}
      />
...
export function ProgressRing({
  ...
  onClick?: () => void;
  id?: string;
  /** Force a full lime ring (e.g. review queue empty). */
  complete?: boolean;
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "relative font-mono font-bold leading-none",
          typeof label === "string" && String(label).length > 2 ? "text-[9px]" : "text-[11px]",
        )}
      >
        {label}
      </span>
